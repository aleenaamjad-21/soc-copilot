...
SAMPLE_ALERTS = [
    ("Brute Force", "185.220.101.45", "10.0.0.12", "47 failed SSH login attempts for user 'admin' in 60 seconds"),
    ("Port Scan", "45.155.205.233", "10.0.0.0/24", "Sequential SYN packets across ports 1-1024 detected from single host"),
    ...
    ("Brute Force", "194.26.29.156", "10.0.0.15", "RDP login failures, 12 attempts, single source IP, stopped after lockout"),
    ...
    ("Port Scan", "89.248.165.74", "10.0.0.0/24", "Full port range scanned from external IP, no prior contact with network"),
    ("Brute Force", "193.32.162.157", "10.0.0.18", "200+ failed logins across 15 usernames in 2 minutes — password spraying pattern"),
